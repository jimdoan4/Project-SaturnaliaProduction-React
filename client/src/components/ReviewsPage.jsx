...
Tickets for the four day ADE Sound Lab program (€25,-) are available here. The program is also accessible with the ADE card, available here and for ADE Pass and ADE Conference Pass holders, available here.</p>
                 ...
                 <Container class='text-center' fluid style={{ background: '#fffdf9', width: '100%', height: '100%', display: 'block', margin: 'auto 0', marginTop: '50px' }}>
                <div class="row">
                     <div class="col profile-pic text-center">
                         <div class="card img-box sexy">
                            ...
                            <Card.Title
														class="text-center"
														style={{ color: 'black', fontWeight: 'bold', marginBottom: '40px', fontSize: '20px', marginTop: '19px' }}>
														Ratings and reviews
													</Card.Title>
                                                    <Card.Text>Certificate of Excellence2015 - 2019 </Card.Text>
                                                    <p>Conference Pass holders, available here.</p>
                                                    <p>features the annual Demolition</p>
                    ...
                    <div class="col profile-pic text-center">
                          <div class="card img-box sexy">
                            ...
                            <Card.Title
                                                    ...
                                                    <Card.Text>1509 Pike Pl Ste 3, Seattle, WA 98101-1526</Card.Text>
                                                    <p>Website: www.google.com</p>
                                                    <p>Call: 404-333-5454</p>
                    ...
                    <div class="col profile-pic text-center">
                        <div class="card img-box sexy">
                            ...
                            <Card.Title
                                                    ...
                                                    <Card.Text>INCREDIBLY FRESH SEAFOOD </Card.Text>
                                                    <p>Conference Pass holders, available here.</p>
                                                    <p>features the annual Demolition</p>
                ...
                <div class="row" style={{ marginBottom: '30px'}}>
                    <div class="row profile-pic text-center">
                        <div class="img-box">
                            ...
                            <img src="https://scontent.fatl1-1.fna.fbcdn.net/v/t1.0-9/31224442_10216201289563031_5475239727873392640_o.jpg?_nc_cat=105&_nc_oc=AQnPsR2ELeNr7Q0ejvJfpXQ90Ji_iImZlW-1oghJaUf2WakO3MBuET6rKXoTLraYuBA&_nc_ht=scontent.fatl1-1.fna&oh=1b533fa3d28179434c68baff3089c2f0&oe=5D92F7C9" style={{width: '20rem', height: '240px'}} class="img-responsive"/>
                           
                        </div>
                     
													<br/>
													<div class=' col card sexy'>
													...
													<Card.Text class="text-center ">
														We travel a lot, and either go to over-priced tourist places, or simple restaurants with outstanding food. We discovered Market Grill on our first trip to Seattle. It is one of my favorites in the world. There are just a few stools and you eat...More
													</Card.Text>
                ...
                <div class="row">
                    <div class="row profile-pic text-center">
                        <div class="img-box">
                            ...
                            <img src="https://scontent.fatl1-1.fna.fbcdn.net/v/t1.0-9/46686054_10217876520602760_1458512799993954304_n.jpg?_nc_cat=102&_nc_oc=AQnodcUhByJGP_8bmqDCTIa1ekQLFbCgg0KfxEfdHRzcOgI8tWb3z7SB8Q-dEJKZ0YU&_nc_ht=scontent.fatl1-1.fna&oh=f99f04875a066c5a12d07ce8abdb28c5&oe=5D91C5FB" style={{width: '20rem', height: '240px'}} class="img-responsive"/>
													...
													<Card.Text class="text-center ">
													Great chunky chowder with lots of ingredients and friendly staff. The server offered me water, crackers and a seat with the chowder. Wanted to order more food because everything looked good! But the chowder was so filling I didn’t order anything else.
													</Card.Text>
                                                    <p>Date of visit: May 2019</p>
													</div>
                    </div>
